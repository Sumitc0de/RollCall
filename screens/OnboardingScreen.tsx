...
const s = StyleSheet.create({
    ...
    mascot: { width: 200, height: 200, alignSelf: 'center', marginTop: 6 },
    title: { textAlign: 'center', fontSize: 32, lineHeight: 40, color: '#20164D', fontFamily: fonts.strong },
    accent: { color: '#6657F5' },
    subtitle: { textAlign: 'center', fontSize: 16, lineHeight: 25, color: '#6F6998', fontFamily: fonts.medium, marginTop: 16 },
    nameArea: { marginTop: 12 },
    ask: { fontSize: 18, color: '#20164D', fontFamily: fonts.strong, textAlign: 'center' },
    askHint: { fontSize: 13, color: '#817AA7', fontFamily: fonts.medium, textAlign: 'center', marginTop: 5, marginBottom: 13 },
    field: { height: 62, backgroundColor: '#fff', borderRadius: 18, borderWidth: 1.5, borderColor: '#D9D2FF', paddingHorizontal: 18, flexDirection: 'row', alignItems: 'center', gap: 12 },
    input: { flex: 1, fontSize: 16, color: '#20164D', fontFamily: fonts.medium },
    button: { height: 64, borderRadius: 21, backgroundColor: '#6650F7', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 16, shadowColor: '#5140D7', shadowOpacity: 0.35, shadowRadius: 12, shadowOffset: { width: 0, height: 7 }, elevation: 7 },
    pressed: { opacity: 0.9, transform: [{ scale: 0.985 }] },
    buttonText: { fontSize: 21, color: '#fff', fontFamily: fonts.display },
});
